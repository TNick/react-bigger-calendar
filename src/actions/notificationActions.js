export const SHOW_NOTIFICATION = 'RBC/SHOW_NOTIFICATION'
...
export const HIDE_NOTIFICATION = 'RBC/HIDE_NOTIFICATION'
export const hideNotification = () => ({
  type: HIDE_NOTIFICATION
})

export const RESET_NOTIFICATION = 'RBC/RESET_NOTIFICATION'
